...
TwinBKP also has the shortest observed elapsed time at 0.05 seconds, compared with 8.71 seconds for full BKP and 519.62 seconds for LGP.
...
\newpage
\appendix
\section{Evaluation of Pointwise Uncertainty and Coverage} \label{app:coverage}
